...
use imarc\addressfieldtypes\assetbundles\combinedfield\CombinedFieldAsset;
 ...
 * @since     1.0.0
 */
class Combined extends Dropdown
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('address-field-types', 'Combined (Address Fields)');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'address-field-types/_components/fields/Combined_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(CombinedFieldAsset:
        :class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').AddressFieldTypesCombined(" . $jsonVars . ");");
        ...
        return Craft::$app->getView()->renderTemplate(
            'address-field-types/_components/fields/Combined_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
